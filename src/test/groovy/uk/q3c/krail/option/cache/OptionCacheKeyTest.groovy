...
package uk.q3c.krail.option.cache
...
class OptionCacheKeyTest extends Specification {
    ...
    OptionKey<Integer> optionKey = new OptionKey<>(33, MockOptionContext.class, MockLabelKey.Yes, MockLabelKey.Cancel, "a", "b")
    ...
    def "toString()"() {
        ...
        expect:
        refKey.toString().equals("OptionCacheKey{hierarchy=Simple, requestedRankName='top dog', optionKey=MockOptionContext-Yes-a-b, rankOption=HIGHEST_RANK}")
    }
