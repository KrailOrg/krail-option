...
import uk.q3c.krail.persist.inmemory.store.DefaultInMemoryPatternStore;
import uk.q3c.krail.persist.inmemory.store.InMemoryDescriptionKey;
...
public class InMemoryModule extends AbstractModule implements I18NPersistenceEnabler<InMemoryModule>, OptionPersistenceEnabler<InMemoryModule> {
    ...
    private I18NKey description = InMemoryDescriptionKey.Data_is_held_in_memory;
    private I18NKey name = InMemoryLabelKey.In_Memory;
    ...
    public boolean isProvideOptionDao() {
        return provideOptionDao;
    }

    public boolean isProvidePatternDao() {
