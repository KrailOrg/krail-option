...
public class DefaultOption extends OptionBase {
    ...
    @Inject
    public DefaultOption(OptionCache optionCache, @UserHierarchyDefault UserHierarchy hierarchy, OptionPermissionVerifier permissionVerifier, GlobalBusProvider globalBusProvider) {
        super(optionCache, hierarchy, permissionVerifier, globalBusProvider);
    }
}
